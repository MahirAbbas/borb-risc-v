...
case class test_hazards_cop() extends Component {
...
object test_hazards_cop_app extends App {
  SimConfig.withWave.compile(new test_hazards_cop()).doSim { dut =>
    ...
    val instructions: List[(Long, BigInt)] = List(
      ...
      (84,  BigInt("015a0b33",16 )),  // add  x22, x20, x21      # depends on x20,             # x22 = 29
    ...
    for(i <- 0 to 30) {
      ...
      // println(dut.coreArea.readpc.pc.toBigInt)
      // println(dut.coreArea.readHere.pc.toBigInt)

      
      // println(dut.coreArea.dispatcher.hcs.inValue.toBigInt)
    ...
    // println(s"${dut.coreArea.srcPlugin.regfileread.regfile.mem.getBigInt(16).toLong}")
    // println(s"${dut.coreArea.srcPlugin.regfileread.regfile.mem.getBigInt(17).toLong}")
    // println(s"${dut.coreArea.srcPlugin.regfileread.regfile.mem.getBigInt(18).toLong}")
    // println(s"${dut.coreArea.srcPlugin.regfileread.regfile.mem.getBigInt(19).toLong}")
    // println(s"${dut.coreArea.srcPlugin.regfileread.regfile.mem.getBigInt(20).toLong}")
    // println(s"${dut.coreArea.srcPlugin.regfileread.regfile.mem.getBigInt(21).toLong}")
    // println(s"${dut.coreArea.srcPlugin.regfileread.regfile.mem.getBigInt(22).toLong}")
    // println(s"${dut.coreArea.srcPlugin.regfileread.regfile.mem.getBigInt(23).toLong}")
  }
}
